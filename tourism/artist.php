...
<div class="container">
  ...
  <thead>
    <tr>
      <th scope="col">id</th>
      <th scope="col">Nume Artist</th>
      <th scope="col">studiit</th>
  ...
  <div id="site_content">
	...
	<div id="logo">
        ...
        <div id="logo_text">
                  ...
                  <h1><a href="obiect.php">Lista <span class="logo_colour">Artist</span></a></h1>
...
include "config.php"; 
$records = mysqli_query($conn,"select * FROM artist ORDER BY id ASC"); 
...
?>
  <tr>
    ...
    <td><?php echo $data['nume_artist']; ?></td>
    <td><?php echo $data['studii']; ?></td>
    <td><?php echo $data['varsta']; ?></td>
