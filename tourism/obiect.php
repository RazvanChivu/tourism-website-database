  ...
  <div id="site_content">
	...
	<div id="logo">
        ...
        <div id="logo_text">
                  ...
                  <h1><a href="obiect.php">Lista <span class="logo_colour">Obiect</span></a></h1>
...
include "config.php"; 
$records = mysqli_query($conn,"select * FROM obiect ORDER BY id ASC"); 
...
?>
  <tr>
    ...
    <td><?php echo $data['nume_obiect']; ?></td>
    <td><?php echo $data['id_artist']; ?></td>
