...
<div class="container">
  ...
  <thead>
    <tr>
      <th scope="col">id</th>
      <th scope="col">Nume Galerie</th>
      <th scope="col">Tematica</th>
      <th scope="col">muzeu</th>
    </tr>
  </thead>
  <tbody>
  ...
  <div id="site_content">
	...
	<div id="logo">
        ...
        <div id="logo_text">
                  ...
                  <h1><a href="galerie.php">Lista <span class="logo_colour">GALERIE</span></a></h1>
...
include "config.php"; 
$records = mysqli_query($conn,"select * FROM galerie ORDER BY id_galerie ASC"); 

while($data = mysqli_fetch_array($records))
{
?>
  <tr>
    <td><?php echo $data['id_galerie']; ?></td>
    <td><?php echo $data['nume_galerie']; ?></td>
