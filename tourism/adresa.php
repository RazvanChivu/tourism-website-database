  ...
  <div id="site_content">
	...
	<div id="logo">
        ...
        <div id="logo_text">
                  ...
                  <h1><a href="index.php">Lista <span class="logo_colour">Adrese</span></a></h1>
...
include "config.php"; 
$records = mysqli_query($conn,"select * FROM adresa ORDER BY id_adresa ASC"); 
...
?>
  <tr>
    ...
    <td><?php echo $data['strada']; ?></td>
    <td><?php echo $data['oras']; ?></td>
