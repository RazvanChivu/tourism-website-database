...
<div class="container">
  ...
  <thead>
    <tr>
      <th scope="col">id</th>
      <th scope="col">Nume Expozitie</th>
  ...
  <div id="site_content">
	...
	<div id="logo">
        ...
        <div id="logo_text">
                  ...
                  <h1><a href="expozitie.php">Lista <span class="logo_colour">Expozitie</span></a></h1>
...
include "config.php"; 
$records = mysqli_query($conn,"select * FROM expozitie ORDER BY id_expozitie ASC"); 

while($data = mysqli_fetch_array($records))
{
?>
  <tr>
    <td><?php echo $data['id_expozitie']; ?></td>
    <td><?php echo $data['nume_expozitie']; ?></td>
